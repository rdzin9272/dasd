...
Sound:Play();
local args1 = {[1] = "RolePlayName", [2] = "RD SCRIPTS"};
...
local args4 = {[1] = "RolePlayBio", [2] = "RD STUDIOS"};
game:GetService("ReplicatedStorage").RE:FindFirstChild(
...
CRD:AddLabel("Dev - Scritp: CodeCraft / RD SCRIPTS");
local function copyText()
    local textToCopy = "https://discord.gg/NJ5ed926vX";
...
local gameName = "blox fruits and brookhaven";
...
utilitiesTab:AddButton({
    Name = "esp",
    Callback = function() loadstring(game:HttpGet('https://raw.githubusercontent.com/Lucasfin000/SpaceHub/main/UESP'))()
end});
rd:AddButton({
    Name = "rael hub",
...
rd:AddButton({
    Name = "chaos hub",
    Callback = function() loadstring(game:HttpGet("https://pastebin.com/raw/m0zjJLTv"))()
end});
rd:AddButton({
    Name = "sander x",
    Callback = function() loadstring(game:HttpGet(('https://raw.githubusercontent.com/sXPiterXs1111/Sanderxv3.30/main/sanderx3.30')))()
end});

local Section = rd:AddSection({Name = "scripts"});
